...
INSERT INTO `funcoes` VALUES ('função de fornecedores',1),('função de produtos',1),('função de clientes',1),('função de serviços',1),('função de vendas',1),('função de relatorio_produtos',1),('função de relatorio_serviços',1),('função de suporte',1),('função de colaboradores',1);
...
INSERT INTO `usuario` VALUES ('joao','joao@desenvolvedor','1234','desenvolvedor',1),('jhonnes','jhonnes@usuario','1234','chefe de cozinha',0),('Eduardo','eduardo@banco','12345','Admin',1);
...
-- Dump completed on 2023-09-15 17:52:14
